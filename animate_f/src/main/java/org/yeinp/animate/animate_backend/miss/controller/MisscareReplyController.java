...
public class MisscareReplyController {
    ...
    @PostMapping("/misscare/reply/delete/{replyNo}")
    @Transactional
    public void deleteNotice(@PathVariable Long replyNo){
        misscareReplyRepository.deleteMisscareReplyByReplyNo(replyNo);
    }
